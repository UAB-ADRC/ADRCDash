...
redcap_dict <- list(adrc_key = "adc_sub_id",
...
min_fields <- list(registry = c("contact_status"),
                   referral = c("refer_dt"),
                   nacc = c("a1_form_dt"),
...
slice_dict <- list(slice_type = c("first", "last", "all", "first NACC", "longitudinal"),
                   
                   
                   completion_slice = list(type = c("Most Recent Visit", "All Visits"),
                                           slice = c("last", "all")),
                   
                   explorer_slice <- list(visit_type = c("Baseline", "Most Recent", "Longitudinal"),
                                            df_action = list(quote(df_slicer(df, "first", drop_min = "nacc_visit")),
...
#Interactions to add
interact_dict <- list(var1=c("regist_race"),
                      var2=c("regist_sex"),
                      name=c("race_and_sex"))
...
data_dict <- list(data_col = c("race", "sex", "ccc_numeric_stg", "ccc_syndrm_stg", "race_and_sex", "refer_type", "regist_race", "regist_sex", "cdrglob"),
                  new_name = c("NACC Race", "NACC Sex", "AD Numeric Stage", "AD Syndromal Stage", "Race and Sex", "Referral Type", "Race", "Sex", "Global CDR"),
                  
                  col_levels = list(c(1, 2, 3, 4, 5, 50, 99),
                                    c(1, 2),
                                    c(1, 2, 3, 4, 5, 6),
                                    c(1, 2, 3),
                  ...
                  col_labels = list(c("White", "Black / AA", "Am Indian / Alaska Native", "Pacific Islander", "Asian", "Other", "Unknown"),
                                    c("Male", "Female"),
...
data_dict_cont <- list(data_col = c("cs_age"),
                       new_name = c("Age"))
...
data_dict_fact_to_cont <- list(data_col = c("educ", "cdrglob"),
                               new_name = c("Education", "Global CDR"),
                               cast_to_na = list(c("99"),
                                                 c(NULL)),
                               levels_exclude = list(c(NULL),
                                                     c(NULL)))
...
status_dict <- list(levels = c(1:6, 9, -888),
...
regist_dict <- list(levels = c(1,2,0,3,4),
...
refer_dict <- list(levels = c(1, 2, 3, 4),
...
elig_dict <- list(map_from = c(4, 5, 6),
                  map_to = c(1),
                  levels = c(1, 2, 7, 3),
...
enroll_dict <- list(levels_to_drop = c(2, 3, 7),
                    levels = c(1, 4, 5, 6),
...
decline_dict <- list(old_group = c("Race", "Sex"),
...
enroll_flow_dict <- list(var = c("regist", "refer", "elig", "enroll"), 
...
refer_details_dict <- list(type = list(field = "refer_type", plot_field = "Main Referral Source",
                           ...
                           sub_type = list(recast_col = c("refer_clinic", "refer_outreach", "refer_study", "refer_self"),
                                           coalesce = c("refer_clinic", "refer_outreach", "refer_study", "refer_self"),
                                           plot_source_map = c(clinic = "Clinician Referral", outreach = "Community Outreach", study = "Study Referral", self = "Self-Referral")),
                           
                           gsub_string = "refer_",
                           
                           clinic = list(field = "refer_clinic", plot_field = "Clinical Referrals",
                                         labels = c("Memory Disorders", "Primary Care or Geriatrics", "Other Clinic or Unknown"),
                                         plot_labels = c("Memory\nDisorders", "Primary Care\nor Geriatrics", "Other Clinic\nor Unknown")),
                           outreach = list(field = "refer_outreach", plot_field = "Community Outreach",
                                           labels = c("Outreach Event", "ADRC Lecture", "Titusville Event"),
                                           plot_labels = c("Outreach\nEvent", "ADRC\nLecture", "Titusville\nEvent")),
                           study = list(field = "refer_study", plot_field = "Study Referrals",
                                        labels = c("Outside Study", "REGARDS Referral", "Pickering Referral", "Other Referral"),
                                        plot_labels = c("Outside\nStudy", "REGARDS\nReferral", "Pickering\nReferral", "Other\nReferral")),
                           self = list(field = "refer_self", plot_field = "Self-Directed",
                                       labels = c("Alzheimer Association", "Clinical Trials Site", "Family of Affected", "Advertisement", "Word of Mouth", "Other Source"),
                                       plot_labels = c("Alzheimer's\nAssociation", "Clinical\nTrials Site", "Family of\nAffected", "Adertisement\nor Article", "Word of\nMouth", "Other\nSource")),
                           
                           #Used specifically for building by_year tables; see create_refer_details function for quote() context
                           table_cast = list(enroll = list(data_col = c("refer_dt", quote(group_curr), "coalesced_enroll", "Referral Source", "coalesced_details"),
                                                           new_name = c("Referral Date", quote(group_curr), "Status", "Source", "Details")),
                                             decline = list(data_col = c("refer_dt", "Race", "Referral Source", "screen_decline_reasn"),
...
refer_labels_dict <- list(Full = list(var_curr = c("Referral Source"),
                                      df_levels = list(c("Clinic", "Alzheimer's Association", "Community Event", "Outside Studies", "Lectures",
                                                         "Clinical Trials.gov", "Family of Affected", "Flyer", "Word of Mouth", "Other")),
                                      plot_labels = list(c("Clinic", "Alzheimer's\nAssociation", "Community\nEvent", "Outside\nStudies", "Lectures",
                                                           "Clinical\nTrials.gov", "Family of\nAffected", "Flyer", "Word of\nMouth", "Other")),
...
data_dict_component <- list(data_col = c("adc_imag", "cons_csf", "cons_brain"),
                            new_name = c("Neuroimaging", "CSF / Lumbar", "Brain Donation Interest"),
                            
                            #Remapping
                            comp_annot = c("PET", "CSF", "BD"),
                            radio_to_bin = c(TRUE, FALSE, FALSE), #We use this for non-binary radio buttons (would be 1 otherwise for check boxes)
                            ...
                            recast_radio = list(PET = list(map_from = c(2, NA),
                                                            map_to = c(0, 0))),
                            ...
                            build_order = list(PET = c(1, 0, 2),
                                               CSF = c(1, 2, 0),
                                               BD = c(1, 2, 0)),
                            build_names = list(PET = c("Enrolled", "Unlisted",  "Screen Fail"),
                                               CSF = c("Yes", "Undecided", "No"),
                                               BD = c("Yes", "Undecided", "No")),
                            build_table_cols = list(PET = c("Enrolled", "Unlisted", "Screen Fail"),
                                                    CSF = c("Yes", "Undecided", "No"),
                                                    BD = c("Yes", "Undecided", "No")),
...
data_dict_completion <- list(visit = list(label_col = c("coord", "nurse", "rater", 
                                                        "clinical", "cc_conf"),
                                          
                                          data_col = c("clin_coord_comp", "clin_nurse_comp", "memtest_comp",
                                                       "clin_exam_comp", "ccc_syndrm_stg"),
                                          
                                          plot_name = c("Coordinator Eval", "Nurse Eval", "Neuropsych",
                                                        "Clinical Exam", "Consensus Dx"),
                                          
                                          radio_to_check = c(TRUE, TRUE, TRUE,
                                                             TRUE, FALSE),
                                          
                                          reduc = c(NA, NA, NA,
                                                    NA, "flat"),
                                          
                                          reduc_fields = c(NA, NA, NA, 
                                                           NA, NA)),
                             
                             
                             
                             collect = list(label_col = c("plasma", "csf_col", 
                                                          "pib_pet", "tau_pet"),
                                            
                                            data_col = c("biospec_comp", "csf_comp",
                                                         "neuroimag_pib_comp", "neuroimag_tau_comp"),
                                            
                                            plot_name = c("Plasma", "CSF Draw", 
                                                          "PiB PET", "Tau PET"),
                                            
                                            radio_to_check = c(TRUE, TRUE,
                                                               TRUE, TRUE),
                                            
                                            reduc = c(NA,"reduc", 
                                                      "reduc", "reduc"),
                                            
                                            reduc_fields = c(NA, "cons_csf",
                                                             "adc_imag", "adc_imag")),
                             
                             
                             shipped = list(label_col = c("ncrad_biom",  
                                                          "ncrad_gwas", "hudson_alpha"),
                                            
                                            data_col = c("ncrad_blood_ship_dt", 
                                                         "ncrad_gwas_ship_dt", "hudson_ship_dt"),
                                            
                                            plot_name = c("NCRAD Plasma",
                                                          "NCRAD GWAS", "Hudson Alpha"),
                                            
                                            radio_to_check = c(FALSE, 
                                                               FALSE, FALSE),
                                            ...
                                            reduc_fields = list(c("biospec_comp"),
                                                                c("biospec_comp"),
                                                                c("biospec_comp")),
...
data_dict_inventory <- list(dropped_fields = c("record_id", "redcap_survey_identifier", "adni_guid", "ppmp_guid", "adc_cntr_id",
                                               "subj_dob", "subj_age", "brain_id", "form_ver_num", "enroll_status", "subject_info_complete", "biospec_complete"),
                            
                            bulk_drop_string = c("_dt$"),
                            
                            data_col = c("buffy_count", "csfl_count", "dna_count", "pax_count", "pbmc_count", "plasma_count", "serum_count", "urine_count"),
                            
                            biospec_names = c("Buffy Coat", "CSF", "DNA", "PAXgene", "PBMC", "Plasma", "Serum", "Urine")
)
